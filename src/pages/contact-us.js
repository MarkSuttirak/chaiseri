        ...
        <section className="container mx-auto max-w-[1200px] px-6">
          <form action='#' method="POST">
            <div className="flex flex-col gap-y-5">
              <div className="flex items-center w-full">
                ...
                <div className="mt-1 w-full">
                  ...
                  >
                    ...
                    <option value="Recondition / Upgrade Military Vehicle">Recondition / Upgrade Military Vehicle</option>
                    <option value="Customize Armored Vehicle">Customize Armored Vehicle</option>
                  </select>
                </div>
              </div>
              <div className="flex items-center">
                <label htmlFor="first-name" className="block w-[200px] font-bold text-md">
                  First Name *
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="last-name" className="block w-[200px] font-bold text-md">
                  Last Name *
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="company" className="block w-[200px] font-bold text-md">
                  Company
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="address" className="block w-[200px] font-bold text-md">
                  Address
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="city" className="block w-[200px] font-bold text-md">
                  City
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="state" className="block w-[200px] font-bold text-md">
                  State
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="zip" className="block w-[200px] font-bold text-md">
                  Zip
                </label>
                <div className="mt-1 w-full">
                  <input
              ...
              <div className="flex items-center">
                <label htmlFor="country" className="block w-[200px] font-bold text-md">
                  Country of End User
                </label>
                <div className="mt-1 w-full">
                  <select
